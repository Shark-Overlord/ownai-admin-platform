...
export interface PostDraft { id?: string; title: string; summary: string; categoryId?: string; tagIds: string[]; markdown: string; commentsEnabled: boolean | number }
export interface CommunityPost { id: string; version: number; status: string; pinned: boolean | number | string; firstPublishedAt?: string; hasUnpublishedChanges: boolean | number | string; draft: PostDraft; published?: PostDraft }
export interface PostRow { id: string; title: string; summary: string; excerpt?: string; previewMediaType?: 'image' | 'video'; previewMediaUrl?: string; pinned: boolean | number | string; categoryName?: string; tags: CommunityTerm[]; status: string; version: number; hasUnpublishedChanges: boolean | number | string; firstPublishedAt?: string; likeCount: string | number; commentCount: string | number; popularity: string | number }
