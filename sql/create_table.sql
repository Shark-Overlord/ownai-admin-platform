...
(
    ...
    isDeconstructed TINYINT     DEFAULT 0              NOT NULL COMMENT '是否已深度解构',
    deviceFrame   VARCHAR(32)   DEFAULT 'website'       NULL COMMENT '外壳: app | website | none',
    deconstructedPrompt LONGTEXT                        NULL COMMENT '完整解构System Prompt',
    promptData    JSON                                   NULL COMMENT '设计令牌(颜色/排版表格)',
    partsData     JSON                                   NULL COMMENT '核心零件切片代码列表',
    assetsData    JSON                                   NULL COMMENT '矢量图标与素材列表',
    standaloneHtml LONGTEXT                              NULL COMMENT '真机独立HTML源码',
